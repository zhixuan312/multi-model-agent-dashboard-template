...
/**
 * DropdownMenu — the canonical shadcn/Radix dropdown, themed to the token set. Compose
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'ds-pop z-50 min-w-[12rem] overflow-hidden rounded-[var(--r-md)] border border-line bg-surface p-1 shadow-[var(--shadow-pop)]',
          className,
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        inset && 'pl-8',
        variant === 'destructive'
          ? 'text-[var(--rose-deep)] focus:bg-rose-tint data-[highlighted]:bg-rose-tint [&_svg]:text-[var(--rose-deep)]'
